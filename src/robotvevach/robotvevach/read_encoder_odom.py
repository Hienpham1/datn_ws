...
class GPIOZeroEncoderNode(Node):
    ...
    def update_odom(self):
        ...
        dl = (left_ticks - self.last_left_ticks) * (2 * math.pi * self.r / self.ppr)
        dr = (right_ticks - self.last_right_ticks) * (2 * math.pi * self.r / self.ppr)
        self.get_logger().info(f"en1= {self.left_ticks - self.last_left_ticks}, en2= {self.right_ticks - self.last_right_ticks}")
